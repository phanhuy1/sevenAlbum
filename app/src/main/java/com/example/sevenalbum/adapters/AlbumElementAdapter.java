...
import com.example.sevenalbum.activities.mainActivities.PictureActivity;
import com.example.sevenalbum.R;


import java.util.ArrayList;

public class AlbumElementAdapter extends RecyclerView.Adapter<AlbumElementAdapter.ItemAlbumViewHolder> {
    private ArrayList<String> album;
    private ImageView imgPhoto;
    private static int REQUEST_CODE_PIC = 10;

    public AlbumElementAdapter(ArrayList<String> album) {
        this.album = album;
    }
    ...
    public ItemAlbumViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.picture_element_in_album_layout, parent, false);
